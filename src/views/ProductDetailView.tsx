      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-4">
          <div className="aspect-square relative overflow-hidden rounded-2xl border border-zinc-100 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 flex items-center justify-center">
            ...
            />
            {discount > 0 && (
              <span className="absolute top-4 left-4 rounded-md bg-blue-600 px-2.5 py-1 text-[10px] font-black text-white uppercase tracking-wider">
                {discount}% OFF
              </span>
            )}
          </div>
            ...
            <div className="flex gap-3 overflow-x-auto pb-1">
              {product.images.map((img: string, i: number) => (
                <button
                  ...
                  className={`h-14 w-14 overflow-hidden rounded-lg border bg-white flex-shrink-0 transition-all cursor-pointer ${activeImage === img ? 'border-blue-600 ring-2 ring-blue-600/10' : 'border-zinc-200 hover:border-zinc-300 dark:border-zinc-800'}`}
                >
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-zinc-100 dark:border-zinc-800">
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 rounded-xl py-3.5 px-6 text-xs font-bold transition-all cursor-pointer ${!product.inStock ? 'bg-zinc-100 text-zinc-400 cursor-not-allowed dark:bg-zinc-800' : 'bg-[#2874f0] hover:bg-blue-700 text-white shadow-lg shadow-blue-500/10'}`}
            >
